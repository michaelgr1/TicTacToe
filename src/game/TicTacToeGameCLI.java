        ...
        while(!currentBoard.isWinning() && !currentBoard.isTie()) {
            ...
            if(tokenToPlay == Token.X) {
                ...
                do {
                    ...
                    j = in.nextInt();
                }while (!currentBoard.isMoveValid(i,j));

                moveToPlay = new TicTacToeMove(i,j,Token.X);
            ...
            boolean result = currentBoard.executeMove(moveToPlay);
            if(result) {
                System.out.println("Token added");
            } else {
                System.out.println("Token wasn't added");
            }
        }
